...
class HighLightJs
{
    ...
    const BASE_PATH  = 'lib/highlightjs/';
    ...
    {
        return array(
            self::BASE_PATH . 'styles/' . 'github.css',
            self::BASE_PATH . 'styles/' . 'overrides.css'
        );
    }
    ...
    {
        return array(
            self::BASE_PATH . 'highlight.pack.js',
            self::BASE_PATH . 'highlightjs.line-numbers.js'
        );
    }
